...
class YpuTeacherImport(models.TransientModel):
    ...
    def action_download_template(self):
        ...
        sample = [
            ...
            'Yes', 'No', '10',
            'https://ypu.edu.sy/cv/johnsmith.pdf',
    ...
    def action_import(self):
        ...
        for row_num, row in enumerate(rows, start=2):
            ...
            vals = {
                ...
                'google_scholar': _val(7) or False,
                ...
                'is_public': True,
                'cv_url':         _val(14) or False,
                'education':      _html(_val(15)) or False,
                'career':         _html(_val(16)) or False,
                'publications':   _html(_val(17)) or False,
                'courses':        _html(_val(18)) or False,
            }
